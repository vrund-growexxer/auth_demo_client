...
const Navbar = () => {
  ...
  const neautralLight = theme.palette.neutral.light;
  ...
  return <FlexBetween padding="1rem 6%" backgroundColor={alt}>
    <FlexBetween gap="1.75rem">
      ...
      {isNonMobileScreens && (
        <FlexBetween backgroundColor={neautralLight} borderRadius="9px" gap="3rem" padding="0.1rem 1.5rem">
    ...
    {isNonMobileScreens ? (<FlexBetween gap="2rem">
      ...
      <FormControl variant="standard" value={fullName}>
          ...
          sx={{backgroundColor: neautralLight,
          width: "150px",
